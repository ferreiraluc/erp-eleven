-- =============================================
-- RESTAURAR BANCO RENDER A PARTIR DO LOCALHOST
-- Script otimizado para aplicar no Render
-- =============================================

-- Limpar banco atual primeiro (cuidado - remove todos os dados!)
...
DROP TABLE IF EXISTS rastreamentos CASCADE;
...
DROP TABLE IF EXISTS money_transfers CASCADE;
DROP TABLE IF EXISTS exchange_rates CASCADE;

-- Drop sequences
DROP SEQUENCE IF EXISTS seq_pedido_numero CASCADE;

-- Drop views
DROP VIEW IF EXISTS vw_vendas_por_vendedor CASCADE;
DROP VIEW IF EXISTS vw_vendas_semana_atual CASCADE;
...
-- Drop enums
DROP TYPE IF EXISTS tipofolga CASCADE;
DROP TYPE IF EXISTS transferstatus CASCADE;
DROP TYPE IF EXISTS rastreamento_status CASCADE;
DROP TYPE IF EXISTS envio_status CASCADE;
...
-- Agora aplicar o backup completo--
