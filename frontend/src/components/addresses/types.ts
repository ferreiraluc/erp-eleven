...
export interface Freight {id:string;state:string;environment:string;recipient:string;provider_id:string|null;price:string|null;tracking:string|null;label_url:string|null;error:string|null;created_at:string;rates:{id:number;name:string;price:string;delivery_time:number}[]}
