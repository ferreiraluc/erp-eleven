<template>
  <div class="pedido-card" @click="$emit('view', pedido)">
      ...
      <div class="pedido-info">
        ...
        <div class="pedido-details">
          <div class="detail-item">
            ...
            <span class="valor-total">{{ pedido.moeda || 'G$' }} {{ formatCurrency(pedido.valor_total) }}</span>
          </div>
    ...
    <!-- Attachment badge -->
    <div v-if="pedido.anexos_count && pedido.anexos_count > 0" class="attach-badge">
      ...
      {{ pedido.anexos_count }} {{ pedido.anexos_count === 1 ? 'foto' : 'fotos' }}
    </div>
...
.attach-badge svg { width: 0.875rem; height: 0.875rem; }
